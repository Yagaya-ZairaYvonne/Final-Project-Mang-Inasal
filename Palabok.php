...
?>
    ...
    <div class="main-content">
      ...
      <div class="menu-container">
        <div class="menu-item">
          <img src="Images/palabok.jpg" alt="Extra-Creamy-Halo-Halo">
          <p>Palabok</p>
          <?php if ($isLoggedIn): ?>
        ...
        <div class="menu-item">
          <img src="Images/Palabok-and-Chicken-Inasal.jpg" alt="Crema-de-Leche-Small">
          <p>Palabok with Chicken Inasal Regular</p>
          <?php if ($isLoggedIn): ?>
            <form action="order.php" method="POST">
                <input type="hidden" name="item" value="Palabok with Chicken Inasal Regular">
                <input type="hidden" name="quantity" value="1">
        ...
        <div class="menu-item">
          <img src="Images/Palabok-with-1-pc-Pork-BBQ.jpg" alt="Extra-Creamy-Halo-Halo">
          <p>Palabok with 1-pc Pork BBQ</p>
          <?php if ($isLoggedIn): ?>
            <form action="order.php" method="POST">
                <input type="hidden" name="item" value="Palabok with 1-pc Pork BBQ">
                <input type="hidden" name="quantity" value="1">
        ...
        <div class="menu-item">
          <img src="Images/Palabok-party-size2.jpg" alt="Crema-de-Leche-Small">
