...
?>
    ...
    <div class="main-content">
      ...
      <div class="menu-container">
        <div class="menu-item">
          <img src="Images/Extra-Creamy-Halo-Halo.jpg" alt="Extra-Creamy-Halo-Halo">
          <p>Extra Creamy Halo-Halo</p>
          <?php if ($isLoggedIn): ?>
        ...
        <div class="menu-item">
          <img src="Images/Crema-de-Leche-Small.jpg" alt="Crema-de-Leche-Small">
          <p>Crema de Leche Halo-Halo</p>
          <?php if ($isLoggedIn): ?>
            <form action="order.php" method="POST">
                <input type="hidden" name="item" value="Crema de Leche Halo-Halo">
                <input type="hidden" name="quantity" value="1">
                <button type="submit">Order Now</button>
            </form>
        <?php else: ?>
