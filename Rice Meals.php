...
?>
    ...
    <div class="main-content">
      ...
      <div class="menu-container">
        <div class="menu-item">
          <img src="Images/PM1.jpg" alt="pm1">
          <p>Paa Large - PM1</p>
          <button class="order-btn" onclick="openModal()">Order Now</button>
        </div>
      
        <div class="menu-item">
          <img src="Images/PM2.jpg" alt="PM2">
          <p>Pecho Large - PM2</p>
          <button class="order-btn" onclick="openModal()">Order Now</button>
        </div>

        <div class="menu-item">
          <img src="Images/TSM-PAA-2.jpg" alt="TSM-PAA">
          <p>Todo Solb Paa Large</p>
          <button class="order-btn" onclick="openModal()">Order Now</button>
        </div>
      
        <div class="menu-item">
          <img src="Images/TSM-pecho-2.jpg" alt="TSM-PECHO">
          <p>Todo Solb Pecho Large</p>
          <button class="order-btn" onclick="openModal()">Order Now</button>
        </div>

        <div class="menu-item">
            <img src="Images/chicken-insal-regular-3.jpg" alt="chicken inasal regular">
            <p>Chicken Inasal Regular</p>
            <button class="order-btn" onclick="openModal()">Order Now</button>
          </div>
        
          <div class="menu-item">
            <img src="Images/Fiesta-meal.jpg" alt="Fiesta Meal">
            <p>Fiesta Meal</p>
            <button class="order-btn" onclick="openModal()">Order Now</button>>
          </div>
  
          <div class="menu-item">
            <img src="Images/pork-bbq-.jpg" alt="1pc Pork BBQ with Peanut Sauce and Java Rice">
            <p>1pc Pork BBQ with Peanut Sauce and Java Rice</p>
            <button class="order-btn" onclick="openModal()">Order Now</button>
          </div>
        
          <div class="menu-item">
            <img src="Images/2-pc-Pork-BBQ-with-Peanut-Sauce-3.jpg" alt="2pc Pork BBQ with Peanut Sauce and Java Rice">
            <p>2pc Pork BBQ with Peanut Sauce and Java Rice</p>
            <button class="order-btn" onclick="openModal()">Order Now</button>
          </div>

          <div class="menu-item">
            <img src="Images/2-pc-Pork-BBQ-with-Spiced-Vinegar-2.jpg" alt="2 pc Pork BBQ with Spiced Vinegar">
            <p>2pc Pork BBQ with Spiced Vinegar</p>
            <button class="order-btn" onclick="openModal()">Order Now</button>
          </div>
        
          <div class="menu-item">
            <img src="Images/Pork-SisigRM.jpg" alt="Pork Sisig">
            <p>Pork Sisig</p>
            <button class="order-btn" onclick="openModal()">Order Now</button>
          </div>
  
          <div class="menu-item">
            <img src="Images/Bangus-SisigRM.jpg" alt="Bangus Sisig">
            <p>Bangus Sisig</p>
            <button class="order-btn" onclick="openModal()">Order Now</button>
          </div>
