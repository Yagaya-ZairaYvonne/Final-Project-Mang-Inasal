...
?>
    ...
    <div class="main-content">
      ...
      <div class="menu-container">
        ...
        <div class="menu-item">
          <img src="Images/Bangus-Sisig.jpg" alt="Banggus Sisig">
          <p>Bangus Sisig</p>
          <button class="order-btn" onclick="openModal()">Order Now</button>
        </div>

        <div class="menu-item">
          <img src="Images/Pork-Sisig-Family-Size.jpg" alt="Pork-Sisig-Family-Size">
          <p>Pork Sisig Family Size</p>
          <button class="order-btn" onclick="openModal()">Order Now</button>
        </div>
      
        <div class="menu-item">
          <img src="Images/Bangus-Sisig-Family-Size2.jpg" alt="Bangus-Sisig-Family-Size">
